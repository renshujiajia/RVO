...
void generateRoadMap()
{
    ...
    /*v.position = RVO::Vector2(-40.0f,-50.0f);
    roadmap.push_back(v);
    v.position = RVO::Vector2(10.0f,-15.0f);
    roadmap.push_back(v);
    v.position = RVO::Vector2(40.0f,50.0f);
    roadmap.push_back(v);
    v.position = RVO::Vector2(40.0f,0.0f);
    roadmap.push_back(v);
    v.position = RVO::Vector2(-40.0f,0.0f);
    roadmap.push_back(v);*/
...
void setupScenario(RVO::RVOSimulator *sim)
{
    ...
    //指定agent的默认参数(邻居距离，邻居个数，时间地平线，时间平线布斯特，半径，最大速度，const矢量）
    //sim->setAgentDefaults(200.0f, 3, 10.0f, 10.0f, 3.0f, 2.0f);
    sim->setAgentDefaults(100.0f, 10, 5.0f, 5.0f, 3.0f, 10.0f);
