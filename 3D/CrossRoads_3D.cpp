...
//绘制指定ob中的建筑物
void draw_xybuilding(int index)
{
    RVO::Vector2 thepos;
    float tx,tz;
    //顶
    ...
    glBegin(GL_QUADS);
        ...
        glVertex3f(tx,30,tz);
        glVertex3f(tx,30,tz-65);
        glVertex3f(tx+65,30,tz-65);
        glVertex3f(tx+65,30,tz);
    glEnd();
    //左
    glBegin(GL_QUADS);
        glVertex3f(tx,0,tz);
        glVertex3f(tx,0,tz-65);
        glVertex3f(tx,30,tz-65);
        glVertex3f(tx,30,tz);
    glEnd();
    //后
...
void drawRoadWhite()
{
    ...
    glColor3f(1,1,1);
    glBegin(GL_QUADS);
        glVertex3f(20,0.1,20);
        glVertex3f(20,0.1,35);
        glVertex3f(-20,0.1,35);
        glVertex3f(-20,0.1,20);
    glEnd();
    //左
